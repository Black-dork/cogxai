 ...
 * 
 * Every agent is identified by a wallet address (Base public key).
...
export interface AgentIdentity {
  /** Wallet address (Base hex public key or any unique identifier) */
  wallet: string;
 ...
 * In production this would use Base wallet signing.

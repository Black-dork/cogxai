async function main() {
  ...
  const pairs = [
    ...
    ['COGXAI uses four memory types: episodic, semantic, procedural, and self_model', 'how does COGXAI memory work?'],
    ['CogxAI launched as an open-source memory layer for AI agents', 'what is CogxAI and what does it do?'],

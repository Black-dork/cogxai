/**
 * COGXAI Cortex v2 — The Integration Layer
 * 
 ...
 * - Token metering hooks ($COGXAI gas tracking)
 * 
...
export interface MemoryPack {
  ...
  signature?: string;      // Base signature for verification
...
export interface CortexV2Config extends CortexConfig {
  ...
  /** Token metering callback (for $COGXAI gas tracking) */

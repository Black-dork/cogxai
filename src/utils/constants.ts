...
// Price API placeholder — replace with Base DEX price API when token launches
export const DEX_PRICE_URL = '';

export const TWEET_MAX_LENGTH = 4000;
export const TWEET_SAFE_LENGTH = 3900;

// X handle (bot account)
export const BOT_X_HANDLE = process.env.BOT_X_HANDLE || 'cogxaibot';
...
export const MEMORY_CONCEPTS = [
  ...
  'identity_evolution',  // How CogxAI is changing, personality shifts
] as const;

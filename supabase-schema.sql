...
CREATE TABLE IF NOT EXISTS memories (
  ...
  base_signature TEXT,                  -- Base tx signature if committed on-chain
  ...
  encryption_pubkey TEXT,                 -- Base pubkey that encrypted this memory
  owner_wallet TEXT                       -- Base pubkey of the memory owner
);
